...
// Title       : audOM.java                                                       //
//                                                                                //
// Description : Create "Move or Rename Object"  in JSON format                   //
...
class audOM  {
    ...
    public static void main (String[] args) {
        ...
        try {
            ...
            ResultSet rs =
              s.executeQuery("select * from adlumin.audom where omoobj <> '*N' and omoobj not like 'Q%'");
           ...
           while (rs.next()) {
            ...
            Entry              = rs.getString(31).trim() + " " + rs.getString(32).trim() + " " +
            		             rs.getString(33).trim() + " " + rs.getString(34).trim() + " " +
                                 rs.getString(35).trim() + " - Object moved or renamed.";
