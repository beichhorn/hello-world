...
// Title       : audAF.java                                                       //
//                                                                                //
// Description : Create "Authorization Failure" data in JSON format               //
...
class audAF   {
    ...
    public static void main (String[] args) {
        ...
        try {
            ...
            ResultSet rs =
               s.executeQuery("select * from adlumin.audaf where afonam <> '*N' and afonam not like 'Q%'");
